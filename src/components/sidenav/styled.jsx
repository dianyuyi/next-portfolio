...
export const MotionListWrapper = styled(motion.ul)`
  ${tw`absolute flex flex-col justify-center items-center w-full py-6 mt-[10%] backdrop-saturate-200`}
...
export const ItemLink = styled(NextLink)`
  ${tw`no-underline py-0 px-2 text-lg font-light cursor-pointer text-[#222]`}
  pointer-events: fill;
`
...
export const LanguageWrapper = styled.div`
  ...
  &.active {
    ${tw`pb-0 border-b-2 border-b-[#222]`}
  }
`

export const LanguageButton = styled.button`
  pointer-events: fill;
  ${tw`px-2 pb-1 duration-500 text-sm font-light text-[#222]`}
