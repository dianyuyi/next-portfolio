...
export function* getWorkDatabaseRequestSaga({ payload }: DatabaseAction) {
  try {
...
function* getWorkDatabaseSagas() {
  yield takeLatest(actionTypes.GET_DATABASE_REQUEST, getWorkDatabaseRequestSaga)
}

export default getWorkDatabaseSagas
