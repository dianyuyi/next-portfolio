...
export function* getSideDatabaseRequestSaga({ payload }: DatabaseAction) {
  try {
...
function* getSideDatabaseSagas() {
  yield takeLatest(actionTypes.GET_DATABASE_REQUEST, getSideDatabaseRequestSaga)
}

export default getSideDatabaseSagas
